...
public class FacultyLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cb2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "None", "JYC", "Techincal Society", "Sports Wing" }));
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(tf7, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(104, 104, 104)
                        .addComponent(b1))
                    .addGroup(layout.createSequentialGroup()
...
String h=(String)cb2.getItemAt(cb2.getSelectedIndex());
tf7.setText(h);
...
try
{
    ...
    PreparedStatement st=con.prepareStatement("insert into faculty values('"+g+"','"+h+"');");
    st.executeUpdate();
